...
houseName === "lannister" ? console.log("A lannister always pays his debt") : console.log("All men must die");
...
if(salary <= 20000) { 
  alert(`In hand salary  ${salary - ((salary*10)/100)}`);
} else if(salary <= 40000){
  alert(`In hand salary  ${salary - ((salary*20)/100)}`)
